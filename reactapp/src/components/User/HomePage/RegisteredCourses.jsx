...
const RegisteredCourses = () => {
  ...
  const [editStudentData, setEditStudentData] = useState({
    ...
    address: '',
    mobile: '',
    SSLC: '', // Separate state for SSLC
    HSC: '', // Separate state for HSC
    Diploma: '', // Separate state for Diploma
    eligibility: 'Eligible',
  });

  // States for SSLC, HSC, and Diploma
    ...
    axios
      ...
      .then((response) => {
        ...
        setEditStudentData({
          ...
          address: studentData.address || '',
          mobile: studentData.mobile || '',
          SSLC: studentData.sslc || '', // Assign the SSLC state here
          HSC: studentData.hsc || '', // Assign the HSC state here
          Diploma: studentData.diploma || '', // Assign the Diploma state here
          eligibility: studentData.eligibility || 'Eligible',
        });
